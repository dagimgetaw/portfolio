  ...
  return (
    ...
    >
      ...
      >
        <div
          style={{ transform }}
          className="absolute left-1/2 top-1/2 p-4 -translate-x-1/2 -translate-y-1/2 flex justify-start items-start rounded-2xl shadow-[0_8px_16px_rgb(0_0_0/0.4)] bg-black border border-white/10 group-hover/pin:border-white/20 transition duration-700 overflow-hidden"
        >
        ...
        >
          {[0, 2, 4].map((delay, i) => (
            <motion.div
              ...
              className="absolute left-1/2 top-1/2 h-[11.25rem] w-[11.25rem] rounded-full bg-sky-500/10 shadow-[0_8px_16px_rgb(0_0_0/0.4)]"
            />
          ))}
        </div>
